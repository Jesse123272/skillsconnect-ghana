    ...
    if (user.role === 'artisan') {
      try {
        const profiles = await query(
          `SELECT ap.profile_id, ap.category_id, ap.bio, ap.years_experience, ap.starting_price, ap.average_rating, ap.total_reviews, ap.profile_views, ap.is_approved, ap.is_featured, ap.is_available, ap.accepts_emergency, ap.service_areas, c.category_name, c.icon_class
