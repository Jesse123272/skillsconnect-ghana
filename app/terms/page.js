    ...
    <div className="d-flex flex-column min-vh-100" id="terms-conditions-page">
      ...
      <div className="container flex-grow-1 py-5 text-start" style={{ maxWidth: '800px' }}>
        <article className="text-secondary" style={{ lineHeight: '1.8' }}>
          ...
          <section className="mb-5">
            <h2 className="h4 fw-bold text-dark mb-3">3. User Accounts & Verification</h2>
            <p>
          ...
          <section className="mb-5">
            <h2 className="h4 fw-bold text-dark mb-3">4. Rules of Communication & Job Enquiries</h2>
            <p>
          ...
          <section className="mb-5">
            <h2 className="h4 fw-bold text-dark mb-3">5. Reviews & Platform Integrity</h2>
            <p>
          ...
          <section className="mb-5">
            <h2 className="h4 fw-bold text-dark mb-3">6. Modifications and Interruptions</h2>
            <p>
